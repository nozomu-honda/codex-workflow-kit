...
- Schema: `schemas/chatgpt-automation.schema.json`
- Validator: `packages/chatgpt-automation-core/src/config/index.js`
...
| `variables.maxAttempts` | `CODEX_AUTO_FIX_MAX_ATTEMPTS` |
